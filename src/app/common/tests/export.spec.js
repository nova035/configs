(function (angular) {
    ...
    describe("Test export module", function () {
        ...
        beforeEach(function () {
            module("huqas.common.export");
            module("huqasAppConfig");
            module("sil.grid");

            tpl = "<huqas-export></huqas-export>";
        ...
        describe("test export service", function () {
            ...
            it("should export to excel", function () {
                inject(["huqas.common.export.service", function (exportService) {
            ...
            it("should define export function", function () {
                inject(["$controller", function ($controller) {
                    ...
                    $controller("huqas.common.export.controller", {
                        "$scope": scope,
                        "huqas.common.export.service": exportService
                    });
