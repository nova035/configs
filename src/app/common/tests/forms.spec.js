(function () {
    ...
    describe("Test form changes", function () {
        ...
        beforeEach(function () {
            module("huqas.common.forms");

            inject(["huqas.common.forms.changes", function (c) {
                changes = c;
            }]);
        });
    ...
    describe("Test directives", function () {
        ...
        describe("Test drferrmsg2 directive", function () {

            it("should watch errors", function () {
                var tpl = "<drf-err-msg2></drf-err-msg2>";
                var scope = rootScope.$new();
                var el = compile(tpl)(scope);
                expect(el.html()).not.toContain("dl");
            ...
            it("should use defined error key", function () {
                var tpl = "<drf-err-msg2 errors='haha'></drf-err-msg2>";
                var scope = rootScope.$new();
                var el = compile(tpl)(scope);
                scope.haha = {name: ["yeah"]};
                scope.$apply();
