(function (angular, _) {
    ...
    angular.module("huqas.auth.permissions", [
        "huqas.auth.services"
    ])

    .service("huqas.auth.permissions.checker",
        ["huqas.auth.services.login", function (loginService) {
            var AND_SPLITTER = ",";
            var OR_SPLITTER = "|";
    ...
    .directive("requiresPermission", ["huqas.auth.permissions.checker",
    ...
    .directive("requiresUserFeature", ["huqas.auth.permissions.checker",
        function (permChecker) {
            return {
