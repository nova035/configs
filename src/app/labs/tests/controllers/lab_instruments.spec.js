(function (_) {
    ...
    describe("Testing the lab instruments controller: ", function () {
        ...
        beforeEach(function () {
            ...
            module("huqas.labs.controllers.lab_instruments");
        ...
        it("should test lab_instrument.main controller", function () {
            var dt = {
                $stateParams: {lab_id:1,instrument_id: 1}
            };
            var res = {msg: "ok"};
            $httpBackend.expectGET(
                SERVER_URL+"api/v1/labs/1/")
                .respond(200, res);
            controller("lab_instrument.main",dt);
            $httpBackend.flush();
        });

        it("should test failure in http calls lab_instrument.main controller", function () {
            var dt = {
